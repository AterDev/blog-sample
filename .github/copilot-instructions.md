...
<skills>
- 后端规范: .github/skills/perigon-backend/SKILL.md
- 前端规范: .github/skills/perigon-angular/SKILL.md
- Agent导航: .github/skills/perigon-agent/SKILL.md
</skills>
...
- 通用全栈: .github/agent/perigon-agent.md
</agents>

更多细节规范请直接查阅对应技能文件；本文件仅提供总则和入口链接。
